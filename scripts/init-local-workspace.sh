...
copy_required_file "$skill_root/scripts/update-installed-skill.sh" "_local/scripts/update-installed-skill.sh"
...
printf 'Copied Bash workflow scripts, updater, preflight, and templates.\n'
